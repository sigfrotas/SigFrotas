...
class ModelRequisicao {
  ...
  factory ModelRequisicao.fromJson(Map<String, dynamic> json) {
    final model = ModelRequisicao(
      ...
      status: json['status'],
      km_inicial: json['km_inicial'],
      km_termino: json['km_termino'],
      alteracao_lataria: json['alteracao_lataria'],
      nivel_oleo: json['nivel_oleo'],
      qualidade_oleo: json['qualidade_oleo'],
      vazamento_oleo: json['vazamento_oleo'],
      local_vazamento_oleo: json['local_vazamento_oleo'],
      nivel_agua: json['nivel_agua'],
      vazamento_agua: json['vazamento_agua'],
      local_vazamento_agua: json['local_vazamento_agua'],
      luz_acesa: json['luz_acesa'],
      luz_acesa_descricao: json['luz_acesa_descricao'],
      alteracao_farois_dianteiros: json['alteracao_farois_dianteiros'],
      alteracao_farois_trazeiros: json['alteracao_farois_trazeiros'],
    );
